...
contract Domains is ERC721URIStorage {
    ...
    constructor(string memory _tld) payable ERC721("Vibe Name Service", "VNM") {
    ...
    function register(string calldata name) public payable {
        ...
        require(msg.value >= _price, "Not paid enough amount!!");
        ...
        console.log(
            "Regestering %s.%s on the contract with tokenId %d",
            name,
            tld,
            newRecordId
        );
    ...
    function setRecord(string calldata name, string calldata record) public {
        // require(domains[name] == msg.sender, "You are not registered!!!");
